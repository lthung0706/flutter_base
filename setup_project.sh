...
echo -e "\n${BOLD}🔄 Step 4: Updating iOS configuration...${NC}"
...
echo -e "${GREEN}✔ iOS Bundle Identifier and Display Name updated.${NC}"
...
echo -e "\n${BOLD}🔍 Step 7: Running Flutter Analyze Validation...${NC}"
flutter analyze
...
echo -e " 4. (Optional) Setup Firebase: Run ${YELLOW}flutterfire configure${NC} or replace android/app/google-services.json & ios/Runner/GoogleService-Info.plist\n"
